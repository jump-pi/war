...
<script type="text/javascript" src="lib/js/jlinq.js"></script>

<link rel="stylesheet" href="lib/css/bootstrap.min.css" >
<link rel="stylesheet" href="lib/css/jsondoc.css" >
		...
		<div class="container-fluid">
    		...
    		<form class="navbar-form navbar-left col-md-8" role="search">
				<div class="form-group">
		        	<input id="jsondocfetch" type="text" class="form-control" style="width:350px" placeholder="Insert here the JSONDoc URL" autocomplete="off" value="<%= com.jumppi.frwk.jump.RequestContext.getJsondocUrl(application, request) %>">
		        </div>
